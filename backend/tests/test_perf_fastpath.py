...
_GOLDEN = [
    ...
    # 问"一条线路经过/沿线有哪些车站"：口径属 rail_line（目标是**线路**）。
    # 实测缺陷：'京沪线的所有车站' 曾交给 LLM 猜，被判成 station，
    # 于是去调 station.lookup('京沪线') —— 拿线路名当站名查，必然失败。
    ("京沪线经过哪些车站", "rail_line", {"target": "京沪线"}),
    ("京沪线的所有车站", "rail_line", {"target": "京沪线"}),
    ("京沪高铁经过哪些站", "rail_line", {"target": "京沪高速线"}),
    ("京沪线沿线有哪些车站", "rail_line", {"target": "京沪线"}),
    ("京沪线都有哪些站？", "rail_line", {"target": "京沪线"}),
    ("京沪线有多少个车站", "rail_line", {"target": "京沪线"}),
    ("京沪线沿途停靠哪些站", "rail_line", {"target": "京沪线"}),
    ("京沪线的车站列表", "rail_line", {"target": "京沪线"}),
    # 「铁路」后缀也要认（归一化会把 京沪铁路 → 京沪线）
    ("京沪铁路沿线有哪些车站", "rail_line", {"target": "京沪线"}),
